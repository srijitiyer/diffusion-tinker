...
| **FlowGRPO** | OCR text rendering | eval OCR accuracy | 0.64 (ep 5) → **1.00 peak** (ep 10); 0.75–1.00 thereafter (3–4 of 4 prompts) | Validated |
| **DDRL** | Aesthetic + data anchor | mean reward, 40 epochs | 3.77 → ~3.87 peak (steady climb, data anchor stable, no collapse) | Validated |
